...
export const DeliveriesPage:React.FC=()=>{
  const navigate=useNavigate(),addToast=useUiStore(s=>s.addToast),currentUser=useAuthStore(s=>s.currentUser),roles=currentUser.roles?.length?currentUser.roles:[currentUser.role],canCreate=hasPermission(roles,'deliveries.create');
