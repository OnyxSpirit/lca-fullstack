...
export type ModulePermission = 'dashboard'|'modules'|'crm'|'customers'|'vehicles'|'showroom'|'sales'|'deliveries'|'service'|'workshop'|'parts'|'billing'|'documents'|'notifications'|'reports'|'users'|'settings';
...
export const ROLE_PERMISSIONS:Readonly<Record<UserRole,readonly AppPermission[]>>={
  ...
  SALES_MANAGER:[...common,...modules('crm','customers','vehicles','showroom','sales','deliveries','documents','reports'),'crm.stage.update','crm.activity.create','crm.close.won','crm.close.lost','sales.create','sales.update','sales.cancel','showroom.register','showroom.assign','showroom.cancelWaiting','showroom.takeOver','showroom.testDrive','showroom.complete','vehicles.update','vehicles.viewFinancials','customers.create','customers.update','deliveries.create','documents.upload','documents.archive','reports.export'],
  SALES_REP:[...common,...modules('crm','customers','vehicles','showroom','sales','deliveries','documents'),'crm.stage.update','crm.activity.create','crm.close.won','crm.close.lost','sales.create','sales.update','showroom.takeOver','showroom.testDrive','showroom.complete','customers.create','customers.update','deliveries.create','documents.upload'],
  ...
  WORKSHOP_CHIEF:[...common,...modules('vehicles','service','workshop','parts','documents','reports'),'service.update','service.assign','service.invoice','workshop.manageResources','workshop.assign','workshop.timeTrack','parts.manageStock','documents.upload','documents.archive','reports.export'],
