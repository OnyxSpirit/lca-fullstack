...
export type DbRepairOrderStatus = 'planned' | 'received' | 'diagnosis' | 'waiting_approval' | 'in_progress' | 'quality_control' | 'ready' | 'invoiced' | 'delivered' | 'closed' | 'cancelled' | 'abandonment_pending' | 'abandoned';
...
export const repairOrderStatusFromDb: Record<DbRepairOrderStatus, RepairOrderStatus> = { planned: 'PLANIFIE', received: 'RECEPTIONNE', diagnosis: 'DIAGNOSTIC', waiting_approval: 'ATTENTE_VALIDATION', in_progress: 'EN_COURS', quality_control: 'CONTROLE_QUALITE', ready: 'PRET', invoiced: 'FACTURE', delivered: 'LIVRE', closed: 'CLOTURE', cancelled: 'ANNULE', abandonment_pending:'ABANDON_EN_COURS', abandoned:'ABANDONNE' };
...
export const deliveryStatusFromDb: Record<DbDeliveryStatus, DeliveryStatus> = { planned: 'RDV_CONFIRME', preparing: 'EN_PREPARATION', quality_control: 'CONTROLE_QUALITE_EN_COURS', ready: 'VALIDE_POUR_LIVRAISON', delivered: 'LIVRE_SIGNE', cancelled: 'ANNULE' };
