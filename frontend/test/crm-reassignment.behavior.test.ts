...
const users=[{id:'100',displayName:'Elion Rachidy',roles:['ROLE_A'],permissions:{'crm.prospect.update':'OWN'},agencyId:'1',isActive:true},{id:'101',displayName:'Carlos Silva',roles:['ROLE_B'],permissions:{'sales.create':'OWN'},agencyId:'1',isActive:true},{id:'102',displayName:'Technicien',roles:['ROLE_C'],permissions:{},agencyId:'1',isActive:true},{id:'103',displayName:'Commercial externe',roles:['ROLE_D'],permissions:{'sales.create':'OWN'},agencyId:'2',isActive:true},{id:'104',displayName:'Commercial inactif',roles:['ROLE_E'],permissions:{'sales.create':'OWN'},agencyId:'1',isActive:false}];
...
const user=(role:'SALES_MANAGER'|'SALES_REP')=>({id:role==='SALES_MANAGER'?'200':'100',name:role==='SALES_MANAGER'?'Malik Hamed':'Elion Rachidy',email:'test@lca.cg',role,roles:[role],primaryRole:role,roleTitle:'Commercial',avatar:'',agencyId:'1',agencyName:'Agence principale',department:'Ventes',phone:'',status:'active' as const,permissions:{'crm.prospect.view':'AGENCY' as const,'crm.activity.view':'AGENCY' as const,'crm.prospect.update':'AGENCY' as const,...(role==='SALES_MANAGER'?{'crm.prospect.assign':'AGENCY' as const}:{})}});
