...
test('SAV-OR-20 présente le chiffrage avant une validation client read-only',async()=>{
  ...
  const preparation=page.indexOf('Préparation et chiffrage'),approval=page.indexOf('Validation client'),execution=page.indexOf('Interventions techniques, pointage et facturable');
